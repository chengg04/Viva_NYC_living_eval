...
def index(request,trans_type='DRIVING',type='cafe'):
    ...
    import numpy as np
    data = np.genfromtxt('/Users/csy/Downloads/dataforPCT.csv',delimiter=',')
...
def simple(request):
        ...
        datapie = np.genfromtxt('/Users/csy/Downloads/piechart.csv',delimiter=',')
